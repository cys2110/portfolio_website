...
const frameworks = ['React', 'Vue.js', 'Vuetify', 'Django', 'Sequelize', 'Express.js', 'Node.js', 'Axios', 'JWT']
    ...
    <v-container>
        <v-row>
            ...
            <v-col>
                ...
                <v-list :items="tools" class="rounded-b-lg" bg-color="deep-purple-lighten-4"></v-list>
            </v-col>
        </v-row>
    </v-container>
</template>